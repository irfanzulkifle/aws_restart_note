...
**Topics:** Subnet Masks, CIDR Blocks, OSI Model Recap, TCP vs UDP, Application Protocols, DNS, Troubleshooting Tools
**Duration:** ~3 hours
...
- Troubleshooting tools: `ping` (L3), `traceroute` (L3), `nslookup` (DNS), `telnet` (port check, L4), `curl`/`wget` (L7)
- Lab 266: Apache web server not reachable — root causes: service not running + missing port 80 Security Group rule
