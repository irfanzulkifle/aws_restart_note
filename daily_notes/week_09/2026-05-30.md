...
**Topics:** MySQL Database Fundamentals (Labs 268–271)
**Duration:** ~3 hours
...
- Lab 271: BETWEEN (inclusive range), LIKE with wildcards (`%`), aggregate functions (COUNT, SUM, AVG)
- Common mistakes: using `==` instead of `=`, forgetting WHERE on UPDATE/DELETE, parent-child delete order
- Key insight: `DROP TABLE` is permanent; `DELETE FROM` keeps the table structure
