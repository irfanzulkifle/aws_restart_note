# Lecture Notes — April 24, 2026
**Cohort 3 | Project CloudIgnite**
**Topics:** VPC & Networking (NAT Gateway, Route Tables, Security Groups, NACLs)
**Duration:** ~3 hours
...
- Route tables: `0.0.0.0/0 → IGW` makes a subnet public; every subnet needs a route table
