...
**Topics:** ASCII & Binary, Data Types, Functions, Collections, Static vs Dynamic Typing, Control Flow, Git & GitHub, AWS Cloud9
**Duration:** ~3 hours

---

## Key Takeaways
- Primitive types: `int`, `float`, `complex`, `bool`, `str`; composite types: combinations of primitives
- Collections: list (ordered, mutable), set (unordered, no dupes), dict (key-value pairs), queue (FIFO)
